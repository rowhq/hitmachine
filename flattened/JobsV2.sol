...
pragma solidity >=0.4.11 >=0.4.16 >=0.8.4 ^0.8.20 ^0.8.21 ^0.8.22 ^0.8.24;
    ...
    PausableUpgradeable
{
    ...
    event UserPaid(address indexed user, uint256 usdcAmount, uint256 nativeAmount, uint256 timestamp);
    ...
    function payUser(address user, uint256 usdcAmount, uint256 nativeAmount)
        external
        nonReentrant
        whenNotPaused
    ...
    function _payUser(address user, uint256 usdcAmount, uint256 nativeAmount) private {
        if (usdcAmount > 0) {
        ...
        emit UserPaid(user, usdcAmount, nativeAmount, block.timestamp);
    }
