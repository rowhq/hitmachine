...
// source .env && forge script ./script/DeployProd.s.sol --rpc-url https://rpc.sophon.xyz --zksync --broadcast
contract DeployProdScript is Script, TestExt {
    // Configuration
    ...
    function run() external {
        ...
        console.log("\n========================================");
        console.log("MAINNET PRODUCTION DEPLOYMENT COMPLETE!");
        console.log("========================================");
        console.log("\nDeployed Contracts:");
        console.log("-------------------");
        ...
        console.log("========================================");
        console.log("1. Grant roles using GrantRolesProd.s.sol");
