...
# Alternative deployment script using forge create with paymaster for gasless deployment

set -e

echo "========================================"
echo "Deploying to Sophon Testnet with Paymaster"
echo "========================================"
...
echo "========================================"
echo "✅ Deployment Complete (Gasless with Paymaster)!"
echo "========================================"
echo ""
